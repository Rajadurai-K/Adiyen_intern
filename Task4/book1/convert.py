...
with open(r"C:\Users\rajad\OneDrive\Desktop\Adiyen_intern\Task4\book1\BHAGAVAT-GITA.txt", "r", encoding="utf-8") as file:
    text = file.read()
text = re.sub(r'\n\s*\n+', '\n', text) 
...
# Save JSON
with open('final_chunks.json', 'w', encoding='utf-8') as json_file:
